...
class AnnoncesControllerTest < ActionController::TestCase
  ...
  test "should create annonce" do
    assert_difference('Annonce.count') do
      post :create, annonce: { body: @annonce.body, creator_id: @annonce.creator_id, post_date: @annonce.post_date, price: @annonce.price, title: @annonce.title }
    end
  ...
  test "should update annonce" do
    patch :update, id: @annonce, annonce: { body: @annonce.body, creator_id: @annonce.creator_id, post_date: @annonce.post_date, price: @annonce.price, title: @annonce.title }
    assert_redirected_to annonce_path(assigns(:annonce))
  end
